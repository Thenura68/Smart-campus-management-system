    ...
    <div style={styles.page}>
      <div style={styles.container}>
        <div style={styles.header}>
          <h1 style={styles.title}>Assigned Tickets</h1>
          <p style={styles.subtitle}>
            View tickets assigned to you and continue the resolution process.
          </p>
        </div>

        {loading && <p style={styles.info}>Loading assigned tickets...</p>}

        {errorMessage && <p style={styles.error}>{errorMessage}</p>}

        {!loading && !errorMessage && tickets.length === 0 && (
          <div style={styles.emptyState}>
            <p style={styles.emptyTitle}>No assigned tickets</p>
